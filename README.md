...
> - Для docker-вариант на linux (включая vscode) необходимо добавить пользователя в группу docker и обновить, ожидаемый результат: `docker ps` должен запускаться без sudo